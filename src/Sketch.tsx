...
const PHOTO_MATCH: [string, RegExp][] = [
  ...
  ["sushi", /sushi|onigiri/],
  ["egg", /\begg|omelette|omelet|poach|meringue|mayonnaise/],
  ["chocolate", /chocolate|cookie|\bcandy|fudge|dessert|caramel|truffle/],
  ["bread", /bread|sourdough|\bbake a|dough|bagel|\bloaf|focaccia|pretzel/],
  ["salad", /salad|pickle|guacamole|salsa|kimchi|ferment|spice blend|hot sauce/],
  ["cocktail", /cocktail|mixolog|negroni|margarita|bitters/],
  ["coffee", /coffee|cold brew|espresso|barista|latte/],
  ["tea", /\btea\b|matcha|kombucha/],
  ["knife", /knife|dice an onion|\bchop\b|segment a|supreme|cutting board|cheese|charcuterie|butter/],
  ["painting", /paint|watercolor|\bdraw|sketch|collage|comic|chalk|blackout|contour|pixel art|manga|cartoon|doodle|henna/],
  ["pottery", /pottery|ceramic|clay|sculpt|whittl|carve|macram|weav|knit|bead|felt|wire|stamp|origami|kirigami|terrarium jar/],
  ["notebook", /write|writing|\bpoem|haiku|limerick|story|letter|screenplay|zine|journal|memoir|review|acrostic|six-word|verse|song lyric/],
  ["reading", /\bread\b|\bbook\b|library|language|alphabet|braille|morse|count to|phrase|sign language|etymolog/],
  ["guitar", /guitar|ukulele|\bchord|strum/],
  ["drum", /drum|beatbox|percussion|rhythm|whistle|kazoo/],
  ["dance", /dance|moonwalk|salsa|ballet|ballroom|choreo|8 counts|robot/],
  ["dumbbell", /wall sit|weightlift|kettlebell|push-?up|plank|strength|calisthenic|handstand|balance on one/],
  ["swimming", /swim|freediv|snorkel/],
  ["yoga", /yoga|tai chi|\bstretch|pilates|box breathing|meditat|mindful|qigong/],
  ["calm", /gratitude|reflect|weather forecast|done list|thank|kindness|compliment|past self|breathe/],
  ["stargazing", /star|constellation|stargaz|north star|moon|astro|galaxy|planet|cloud|aurora/],
  ["science", /density|lava lamp|invisible|reaction|crystal|dna|rainbow|compass|electric|magnet|solar|microscop/],
  ["herbs", /seed|sprout|regrow|compost|herb|avocado pit|propagat|cutting in water/],
  ["houseplant", /plant|succulent|terrarium|garden|kokedama|bonsai|moss/],
  ["hiking", /hike|hiking|trail|geocach|sit spot|forage|walk|orienteer|skip a stone|leaf boat|kite|north without/],
  ["flower", /flower|bouquet|floristry|bloom|petal|press a/],
  ["chess", /chess/],
  ["games", /board game|game night|tabletop|two-player card|\bdice\b|tangram|sudoku|rubik|puzzle|cryptic|riddle/],
  ["running", /\brun\b|sprint|\bjog|couch to|5k/],
];
